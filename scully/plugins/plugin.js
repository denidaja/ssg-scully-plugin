...
exports.customPlugin = Symbol('customPlugin');
const customPluginFunction = async (html, route) => {
...
registerPlugin('postProcessByHtml', exports.customPlugin, customPluginFunction);
